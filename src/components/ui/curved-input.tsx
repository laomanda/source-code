...
const SELECTABLE_TYPES = ["text", "search", "tel", "url", "password", "email"];
...
export function CurvedInput({
  ...
  onChange,
  onSubmit,
  placeholder = "Tuliskan ide atau saran Anda...",
  buttonText = "Kirim Saran",
  type = "text",
  name,
  ariaLabel,
  theme = "dark",
  ...
  if (geom && layout) {
    ...
    content = (
      ...
      >
        ...
        <path
          className={`opacity-0 transition-opacity duration-[250ms] ease-in-out ${focused ? "opacity-[0.35]" : ""}`}
          d={bandPath}
          fill="none"
          stroke={accentColor}
        ...
        <g clipPath={`url(#${clipId})`}>
          ...
          {focused && (
            ...
            >
              <line y1={-caretH / 2} y2={caretH / 2} stroke={accentColor} strokeWidth="2" strokeLinecap="round">
                <animate
