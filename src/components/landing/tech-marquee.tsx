...
const TECH_STACK: TechItem[] = [
  ...
  },
  {
    name: "React 19",
    icon: (
      <svg className="h-6 w-6 text-[#087EA4]" viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor">
  ...
  },
  {
    name: "Vercel",
    icon: (
      <svg className="h-6 w-6 text-[#000000]" viewBox="0 0 1155 1000" fill="currentColor">
  ...
  },
  {
    name: "Lucide Icons",
    icon: (
      <svg className="h-6 w-6 text-[#272343]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    name: "GitHub",
    icon: (
      <svg className="h-6 w-6 text-[#272343]" viewBox="0 0 24 24" fill="currentColor">
...
export function TechMarquee() {
  return (
    <section className="relative w-full overflow-hidden bg-white/70 py-3 sm:py-4 border-b border-[#BAE8E8]/70 select-none">
        ...
        >
          {TECH_STACK.map((tech) => (
            <div
              ...
              className="flex items-center justify-center h-11 w-11 sm:h-12 sm:w-12 rounded-2xl bg-white shadow-soft-xs hover:scale-110 active:scale-95 transition-all duration-200 cursor-pointer shrink-0"
            >
              {tech.icon}
            </div>
          ))}
